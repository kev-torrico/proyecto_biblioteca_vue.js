        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <vacunas-crear v-if="modalMode === 'crear'" @created="nuevo($event)"></vacunas-crear>
                    <vacunas-editar v-if="modalMode === 'editar'" :item="itemSeleccionado"
                        @updated="modificar($event)"></vacunas-editar>
                </div>
            </div>
        </div>
    </div>
...
<script>
import VacunasCrear from './VacunasCrear.vue';
import VacunasEditar from './VacunasEditar.vue';
...
export default {
    ...
    methods: {
        ...
        obtenerLista() {
            this.axios.get(process.env.VUE_APP_API_URL + '/vacunas?_expand=mascota&_expand=usuario')
                .then((response) => {
        ...
        nuevo(value) {
            this.axios.post(process.env.VUE_APP_API_URL + '/vacunas', value)
                .then((response) => {
                    this.cerrarModal();
                    this.obtenerLista();
                })
        ...
        modificar(value) {
            this.axios.patch(process.env.VUE_APP_API_URL + '/vacunas/' + value.id, value)
                .then((response) => {
                    this.cerrarModal();
                    this.obtenerLista();
                })
        ...
        eliminar(value) {
            if (confirm("¿Está seguro de eliminar este ítem?")) {
                this.axios.delete(process.env.VUE_APP_API_URL + '/vacunas/' + value.id, value)
                    .then((response) => {
                        this.obtenerLista();
                    })
                    .catch((error) => {
